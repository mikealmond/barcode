...
// It is one of the most popular 2D codes because of its ability to be read with slightly modified handheld laser || linear CCD scanners.
...
class PDF417
{
     ...
     * @var string
     */
    protected string $start_pattern = '11111111010101000';
     ...
     * @var string
     */
    protected string $stop_pattern = '111111101000101001';
     ...
     * <li>927 : Identifier for an ECI of a character set || code page</li>
     ...
     *
     * @return array bidimensional array containing characters and classification
     * @protected
     */
    protected function getInputSequences($code) : array
    {
     ...
     * @protected
     */
    protected function getCompaction($mode, $code, $addmode = true) : array
    {
                    ...
                    if (($k = array_search($chval, $this->textsubmodes[$submode])) !== false) {
                        ...
                        for ($s = 0; $s < 4; ++$s) {
                            ...
                            if (($s != $submode) && (($k = array_search($chval, $this->textsubmodes[$s])) !== false)) {
                                ...
                                if (((($i + 1) == $codelen) || ((($i + 1) < $codelen) && (array_search(ord($code[($i + 1)]),
                                                    $this->textsubmodes[$submode]) !== false))) && (($s == 3) || (($s == 0) && ($submode == 1)))) {
