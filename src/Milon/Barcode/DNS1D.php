...
class DNS1D
{
     ...
     * @param string $type  (string) type of barcode:
     *                      <ul><li>C39 : CODE 39 - ANSI MH10.8M-1983 - USD-3 - 3 of 9.</li>
     ...
     *                      <li>EAN2 : 2-Digits UPC-Based Extention</li>
     *                      <li>EAN5 : 5-Digits UPC-Based Extention</li>
     *                      <li>EAN8 : EAN 8</li>
     *                      <li>EAN13 : EAN 13</li>
     *                      <li>UPCA : UPC-A</li>
     *                      <li>UPCE : UPC-E</li>
     ...
     *                      <li>PHARMA2T : PHARMACODE TWO-TRACKS</li></ul>
     * @param int    $w     (int) Minimum width of a single bar in user units.
     * @param int    $h     (int) Height of barcode in user units.
    ...
    public function getBarcodeSVG($code, $type, $w = 2, $h = 30, $color = 'black', $showCode = true, $inline = false)
    {
        ...
        $svg .= '<svg width="' . round(($this->barcode_array['maxw'] * $w),
                3) . '" height="' . $h . '" version="1.1" xmlns="http://www.w3.org/2000/svg">' . "\n";
        ...
        if ($showCode) {
            $svg .= "\t" . '<text x="' . (round(($this->barcode_array['maxw'] * $w),
                        3) / 2) . '" text-anchor="middle"  y="' . ($bh + 12) . '" id="code" fill="' . $color . '" font-size ="12px" >' . $code . '</text>' . "\n";
        }
     ...
     * @protected
     */
    public function getBarcodeHTML(string $code, string $type, int $w = 2, int $h = 30, string $color = 'black', $showCode = false)
    {
        $this->setBarcode($code, $type);

        $html = vsprintf(
            '<div style="font-size:0;position:relative;width:%upx;height:%upx;">',
            [
        ...
        foreach ($this->barcode_array['bcode'] as $k => $v) {
            ...
            if ($v['t']) {
                ...
                // draw a vertical bar
                $html .= vsprintf(
                    '<div style="background-color:%s;width:%upx;height:%upx;position:absolute;left:%upx;top:%upx;">&nbsp;</div>',
                    [
                        $color,
                        $bw,
                        $bh,
    ...
    /**
     * Return a PNG image representation of barcode (requires GD library).
     *
     * @param $code        (string) code to print
     * @param $type        (string) type of barcode:
     *                     <ul>
     ...
     *
     * @return string|false image or false in case of error.
     * @protected
     */
     ...
     * @param $color       (array) RGB (0-255) foreground color for bar elements (background is transparent).
     *
     * @return string|false the path as a string or false in case of error.
     * @protected
     */
    protected function getBarcodePNGPath($code, $type, $w = 2, $h = 30, $color = [0, 0, 0], $showCode = false)
    {
        if (!function_exists('imagecreate')) {
            return false;
        }
        ...
        $file_name = Str::slugify($code . $type);
     ...
     *
     * @param $code        (string) code to print
     * @param $type        (string) type of barcode: <ul><li>C39 : CODE 39 - ANSI MH10.8M-1983 - USD-3 - 3 of 9.</li>
     *                     <li>C39+ : CODE 39 with checksum</li>
     *                     <li>C39E : CODE 39 EXTENDED</li>
     *                     <li>C39E+ : CODE 39 EXTENDED + CHECKSUM</li>
     *                     <li>C93 : CODE 93 - USS-93</li>
     ...
     * @param $color       (array) RGB (0-255) foreground color for bar elements (background is transparent).
     *
     * @return string|false The URL or false in case of error.
     * @protected
     */
    protected function getBarcodePNGUri($code, $type, $w = 2, $h = 30, $color = [0, 0, 0])
    {
        return $this->getBarcodePNGPath($code, $type, $w, $h, $color);
    }
     ...
     * @param bool   $extended (boolean) if true uses the extended mode.
     * @param bool   $checksum (boolean) if true add a checksum to the code.
     *
     * @return array|false barcode representation.
     * @protected
     */
    protected function barcode_code39(string $code, bool $extended = false, bool $checksum = false)
    {
        $chr['0'] = '111331311';
        $chr['1'] = '311311113';
        $chr['2'] = '113311113';
     ...
     * @protected
     */
    protected function checksum_code39(string $code)
    {
        $chars = [
            '0',
            '1',
    ...
    protected function barcode_eanupc($code, $len = 13)
    {
        ...
        if ($code_len == $data_len) {
            ...
            throw new WrongCheckDigitException($r, intval($code[$data_len]));
        }
        if ($len == 12) {
            // UPC-A
            $code = '0' . $code;
     ...
     *                     <li>The Mailer or Customer Identifier shall be assigned by USPS as a unique, 6 or 9 digit number that identifies a business entity. The allowable encoding range for the 6 digit Mailer ID shall be 000000- 899999, while the allowable encoding range for the 9 digit Mailer ID shall be 900000000-999999999.</li>
